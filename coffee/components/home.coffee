        ...
        <Col xs=12>
          ...
          <Row className='info'>
            <Col mdOffset=2 md=3 xs=12 className='left'>
              ...
              <p className='center'>
                We invite you to join us at The Wedding Garden right in the heart of Carbondale to celebrate our wedding. Reception to follow at the venue, featuring indoor seating, an outdoor area with a bonfire, and an open bar.
              </p>
